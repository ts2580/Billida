...
public interface RentLockerRepository {
	...
	@Insert("insert into locker(LOCKER_ID, USER_CODE, LOCKER_TITLE, LOCKER_CONTENT, "
			+ "LOCKER_IMAGE, LOCKER_SIZE, LOCKER_PASSWORD, LOCATION, RENTABLE_DATE_START, RENTABLE_DATE_END, LATITUDE, LONGITUDE)"
			+ "values(LOCKER_ID.nextval, #{userCode}, #{lockerTitle}, #{lockerContent}, #{lockerImage}, #{lockerSize}, "
