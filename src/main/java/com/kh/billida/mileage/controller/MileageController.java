...
public class MileageController {
	...
	@GetMapping("mileage/update-mileage")
	public String updateMileage(String userCode, int mileage) {
		
		Mileage userMileage = mileageService.selectUserMileage(userCode);//유저코드의 마일리지 존재하는지 확인
		
		Map<String, Object> commandMap = new HashMap<String, Object>();
		commandMap.put("userCode", userCode);
		commandMap.put("mileage", mileage);
